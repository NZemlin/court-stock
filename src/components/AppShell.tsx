  ...
  return (
    <div className="min-h-dvh bg-bg text-ink">
      <div className="mx-auto flex min-h-dvh max-w-[1400px]">
        <aside className="sticky top-0 hidden h-dvh w-56 shrink-0 flex-col border-r border-border bg-card px-4 py-6 md:flex">
          ...
          <p className="mt-auto px-3 text-xs leading-relaxed text-subtle">
            ClubAutomation retail CSV in the browser. Nothing is sent to a server.
          </p>
        </aside>
      ...
      <nav className="fixed inset-x-0 bottom-0 z-20 border-t border-border bg-card/95 backdrop-blur-sm md:hidden">
